...
public class ProximityTest {
    ...
    public void testDistanceBetween() throws Exception {
        ...
        Assert.assertEquals(6814.3, Proximity.distanceBetween(bondiBeach, operaHouse).inMetres(), 0.1);
        Assert.assertEquals(1104, Proximity.distanceBetween(bondiBeach, penguinIsland).inKilometres(), 1);
        Assert.assertEquals(1106, Proximity.distanceBetween(operaHouse, penguinIsland).inKilometres(), 1);
    }
}
